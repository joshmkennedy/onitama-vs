...
export default function Board({
	...
	const isShowingConfirm = React.useMemo(
	...
	const chooseTile = React.useCallback(
		...
		[selectedCard, selectedUnit, selectedPos, gameState],
	);
	...
	const handlePlayTurn = React.useCallback(() => {
		...
		setSelectedPos(null);
		setSelectedUnit(null);
	}, [selectedUnit, selectedPos, selectedCard]);
	...
	}, [selectedCard, selectedUnit, gameState?.currentPlayer]);
