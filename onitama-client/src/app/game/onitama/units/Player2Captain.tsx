...
export function Player2CaptainUnit() {
	return (
		<svg
			width="250"
			height="250"
		...
		>
			...
			<g mask="url(#mask0_1_63)">
				...
				<ellipse cx="28.5" cy="76.5" rx="33.5" ry="32.5" fill="#0A4B87" />
				<ellipse cx="221.5" cy="76.5" rx="33.5" ry="32.5" fill="#0A4B87" />
			</g>
			<mask
				id="mask1_1_63"
				style={{ maskType: "alpha" }}
			...
			<g className={styles.sword}>
				<rect x="47" y="20" width="14" height="113" rx="7" fill="#053A6C" />
				<rect x="33" y="125" width="40" height="8" rx="4" fill="#053A6C" />
			</g>
		</svg>
	);
}
